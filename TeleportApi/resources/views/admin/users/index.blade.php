                    ...
                    <tbody>
                        @foreach($users as $user)
                            <tr>
                                ...
                                <td class="text-center forn-w600"><span class="badge badge-pill badge-primary">@if ($user->user_role == 'contractor')Соискатель@elseif($user->user_role=='employer')Работодатель@endif</span></td>
